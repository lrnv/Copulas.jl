...
# Kendall's tau - using the transformation property of PowerGenerator
# For theoretical background, see Nelsen (2006), theorem 4.5.1
τ(G::PowerGenerator) = τ(G.G)

# Use the underlying generator's williamson distribution
# The PowerGenerator preserves the Williamson transform structure
williamson_dist(G::PowerGenerator, d) = williamson_dist(G.G, d)
