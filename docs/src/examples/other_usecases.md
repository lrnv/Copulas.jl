...
- [`UncertaintyQuantification.jl`](https://github.com/JuliaUQ/UncertaintyQuantification.jl) uses `Copulas.jl`'s dependence structures to do Simulation-based reliability analysis, Sensitivity analysis, Metamodeling, Bayesian updating and a lot of other fancy stuff. Check their work out it's worth it !
