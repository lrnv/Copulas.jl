...
@testitem "Generic OLS" tags=[:Generic, :ExtremeValueCopula, :EmpiricalEVCopula] setup=[M] begin M.check(EmpiricalEVCopula(randn(M.rng, 2,10); estimator=:ols, pseudos_values=false)) end
@testitem "Generic OLS" tags=[:Generic, :ExtremeValueCopula, :EmpiricalEVCopula] setup=[M] begin M.check(EmpiricalEVCopula(randn(M.rng, 2,20); estimator=:ols, pseudos_values=false)) end
@testitem "Generic Pickhands" tags=[:Generic, :ExtremeValueCopula, :EmpiricalEVCopula] setup=[M] begin M.check(EmpiricalEVCopula(randn(M.rng, 2,10); estimator=:pickands, pseudos_values=false)) end
@testitem "Generic Pickhands" tags=[:Generic, :ExtremeValueCopula, :EmpiricalEVCopula] setup=[M] begin M.check(EmpiricalEVCopula(randn(M.rng, 2,20); estimator=:pickands, pseudos_values=false)) end
@testitem "Generic CFG" tags=[:Generic, :ExtremeValueCopula, :EmpiricalEVCopula] setup=[M] begin M.check(EmpiricalEVCopula(randn(M.rng, 2,10); estimator=:cfg, pseudos_values=false)) end
@testitem "Generic CFG" tags=[:Generic, :ExtremeValueCopula, :EmpiricalEVCopula] setup=[M] begin M.check(EmpiricalEVCopula(randn(M.rng, 2,20); estimator=:cfg, pseudos_values=false)) end
