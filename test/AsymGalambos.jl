...
@testitem "Generic" tags=[:AsymGalambosCopula] setup=[M] begin M.check(AsymGalambosCopula(0.0, [0.0, 0.0])) end
@testitem "Generic" tags=[:AsymGalambosCopula] setup=[M] begin M.check(AsymGalambosCopula(0.0, [1.0, 1.0])) end
@testitem "Generic" tags=[:AsymGalambosCopula] setup=[M] begin M.check(AsymGalambosCopula(0.0, [rand(M.rng), rand(M.rng)])) end
...
@testitem "Generic" tags=[:AsymGalambosCopula] setup=[M] begin M.check(AsymGalambosCopula(10+5*rand(M.rng), [0.0, 0.0])) end
...
@testitem "Generic" tags=[:AsymGalambosCopula] setup=[M] begin M.check(AsymGalambosCopula(5+4*rand(M.rng), [0.0, 0.0])) end
...
@testitem "Generic" tags=[:AsymGalambosCopula] setup=[M] begin M.check(AsymGalambosCopula(rand(M.rng), [0.0, 0.0])) end
