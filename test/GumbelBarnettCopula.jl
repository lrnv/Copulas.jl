...
@testitem "Generic" tags=[:GumbelBarnettCopula] setup=[M] begin M.check(GumbelBarnettCopula(3,0.2)) end
@testitem "Generic" tags=[:GumbelBarnettCopula] setup=[M] begin M.check(GumbelBarnettCopula(3,rand(M.rng)*0.45)) end
