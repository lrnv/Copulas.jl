...
# Re-enable these files sequentially, in the original order, only after the
# preceding prefix is green. This keeps failures local and prevents a late
# numerical hang from masking earlier migration regressions.
testfiles = (
    "Aqua.jl",
    "api/constructors.jl",
