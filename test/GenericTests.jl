...
@testset for C in unique(Bestiary)
    ...
    @testif can_be_fitted(C, d) "Fitting interface"  begin
        @testif has_unbounded_params(C, d) "Unbouding and rebounding params" begin
            ...
            @test Copulas._unbound_params(CT, d, Distributions.params(typeof(Copulas._example(CT, d))(θ₀...))) == Copulas._unbound_params(CT, d, θ₀)
            ...
            @test Copulas._unbound_params(CT, d, Distributions.params(typeof(C)(θ₀...))) == Copulas._unbound_params(CT, d, θ₀)
        end
