@testitem "Generic tests on every copulas" begin
    ...
    bestiary = unique([
        ...
        AsymGalambosCopula(rand(rng, Uniform(10.0, 15.0)), [rand(rng, Uniform(0, 1)), rand(rng, Uniform(0, 1))]),
        AsymGalambosCopula(rand(rng, Uniform(5.0,9.0)), [0.0, 0.0]),
        AsymGalambosCopula(rand(rng, Uniform(5.0,9.0)), [1.0, 1.0]),
        AsymGalambosCopula(rand(rng, Uniform(5.0,9.0)), [rand(rng, Uniform(0, 1)), rand(rng, Uniform(0, 1))]),
        ...
        AsymLogCopula(rand(rng, Uniform(1.0, 5.0)), [rand(rng, Uniform(0, 1)), rand(rng, Uniform(0, 1))]),
        AsymLogCopula(rand(rng, Uniform(10.0, 15.0)), [1.0, 1.0]),
        AsymLogCopula(rand(rng, Uniform(10.0, 15.0)), [rand(rng, Uniform(0, 1)), rand(rng, Uniform(0, 1))]),
